...
function RoleMainText() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center -translate-y-12">
      ...
      <h1 className="text-center text-4xl font-bold italic tracking-wide text-white sm:text-5xl xl:text-6xl">
        DECRYPTION COMPLETE
      </h1>
    </div>
  );
